    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.tableHeader}>
          ...
          {/* textTransform off for this one: the header style shouts every
              label in capitals, and she asked for "Best Before" as written. */}
          <Text style={[styles.thText, styles.colTht, { textTransform: 'none' }]}>Best Before</Text>
